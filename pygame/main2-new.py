...
player = pygame.transform.scale(pygame.image.load('gold4.png').convert_alpha(), size=player_size)
player_rect = player.get_rect()
player_speed = 10

# bg = pygame.transform.scale(pygame.image.load('Ocean.png').convert(), screen)
bg = pygame.transform.scale(pygame.image.load('ocean1.png').convert(), screen)
bgX = 0
bgX2 = bg.get_width()
bg_speed = 2
...
def create_enemy():
    enemy_img = pygame.image.load('shark.png').convert_alpha()
...
def create_bonus():
    bonus_img = pygame.image.load('bubble.png').convert_alpha()
