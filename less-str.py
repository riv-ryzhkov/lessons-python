...
# print('Temperature is +24' + chr(186) + 'C')

# print(a.startswith('H'))
# print(a.endswith('.ua') or a.endswith('.com'))
# print(a)
...
# #     print(i, '->', ord(i))
#
# print('Temprature is +24' + chr(186) + 'C!')
...
# for i in range(256):
#     print(chr(i), '->', i)
# print('Tempetature is 25', chr(186), ' C', sep='')
...
a = 'Ukraine'
b = 'University'
print('How {1} Are {0} you'.format(a, b))
